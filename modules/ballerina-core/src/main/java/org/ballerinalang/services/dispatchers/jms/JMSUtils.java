...
public class JMSUtils {
    ...
    public static Map<String, String> preProcessJmsConfig(AnnotationAttachmentInfo jmsConfig) {
        ...
        processPropertiesString(jmsConfig, configParams);
        preProcessForMB(configParams);
        updateMappedParameters(configParams);
        return configParams;
    }

    private static void preProcessForMB(Map<String, String> configParams) {
    ...
    private static void processPropertiesString(AnnotationAttachmentInfo jmsConfig, Map<String, String> configParams) {
